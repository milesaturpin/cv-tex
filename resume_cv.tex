...
%\position{Data Science{\enskip\cdotp\enskip}Philosophy} % Your expertise/fields

\makecvfooter{\today}{Miles A. Turpin~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
